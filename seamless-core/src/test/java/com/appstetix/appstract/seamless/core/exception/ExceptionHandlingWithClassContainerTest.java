...
import com.appstetix.appstract.seamless.core.exception.setup.*;
...
public class ExceptionHandlingWithClassContainerTest {

    private static ExplicitExceptionsAPI api;

    @BeforeClass
    public static void setUp(TestContext context) throws Exception {
        api = new ExplicitExceptionsAPI();
    }
    ...
    @EnableExceptionHandling( exceptionsClass = TestExceptionContainer.class )
